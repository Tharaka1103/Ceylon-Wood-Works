...
$sql = "INSERT INTO paint_orders (paint_color, letters, quantity, address, name, contact, paint_name, paint_id) 
        VALUES (:paint_color, :letters, :quantity, :address, :name, :contact, :paint_name, :paint_id)";
