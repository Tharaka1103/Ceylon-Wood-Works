...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $conn->prepare("INSERT INTO plank_purchases (plank_name, customer_name, email, phone, quantity, address) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssssss", $plankName, $customerName, $email, $phone, $quantity, $address);
        $stmt->execute();
            ...
            <div class="col-md-8">
                <div class="confirmation-card p-5">
                    ...
                    <div class="text-center mt-4">
                        <a href="FinishedPlanks.php" class="btn btn-primary">Return to Finished Planks</a>
                    </div>
                </div>
            </div>
        </div>
