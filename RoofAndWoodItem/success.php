...
<body>
    ...
    <div class="success-container">
        ...
        <div class="success-message">Yoyr Paint Prder Placed Successful!</div>
        <div class="success-text">You will recive an confirmaiton email as soon as posible</div>
        <a href="WoodItems.php" class="btn btn-primary">Back to Wood Items</a>
    </div>
